...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        self.screen = pygame.display.set_mode((self.settings.screen_width,self.settings.screen_height))  # to create a display window
    ...
    def run_game(self):    # the game is controlled by this method
    ...
    def _check_alien_bullet_collision(self):
        """Check collision and create new fleet"""
    ...
    def _create_fleet(self):
        # create a aliens and space around it
        alien = Alien(self)
